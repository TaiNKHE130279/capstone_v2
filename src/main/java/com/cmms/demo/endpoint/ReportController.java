...
public class ReportController {
    ...
    public ResponseEntity<DebtReportOutput> getDebtReport(@RequestParam("page") int pageIndex,
                                                          @RequestParam("limit") int pageSize){
        return new ResponseEntity<>(service.getDebtReport(pageIndex, pageSize), HttpStatus.OK);
    }
}
